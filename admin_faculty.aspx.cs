...
namespace stc
{
    public partial class admin_faculty : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update staff set sno='" + TextBox1.Text + "',staff_name='" + TextBox3.Text + "',password='" + TextBox4.Text + "',incharge='" + TextBox5.Text + "',qualification='" + TextBox6.Text + "',department='" + TextBox7.Text + "',mobile_num='" + TextBox8.Text + "',hod='" + TextBox9.Text + "',stream='" + TextBox10.Text + "' where staff_id='" + TextBox2.Text + "'";
            cmd.ExecuteNonQuery();
            GridView1.DataBind();
            con.Close();
        }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from staff where staff_id='" + TextBox2.Text + "'";
            cmd.ExecuteNonQuery();
            GridView1.DataBind();
            con.Close();
        }
